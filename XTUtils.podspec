...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/XiangtaiCompany/XTUtils.git"
  ...
  s.source       = { :git => "https://github.com/XiangtaiCompany/XTUtils.git", :tag => s.version.to_s }
  ...
  s.source_files  = "XTUtils/XTUtils/**/*.{h,m}"
